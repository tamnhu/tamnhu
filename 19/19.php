...
require_once 'lib/scss.inc.php';
    ...
    $styles = $scss->compile('@import "19-styles.scss";');

    $css = fopen('css/19-styles.css','w');
...
<head>
    ...
    <link href="<?php echo $url_path ?>/css/19-styles.css" rel="stylesheet" type="text/css" />
