...
require_once 'lib/scss.inc.php';
    ...
    $styles = $scss->compile('@import "20-styles.scss";');

    $css = fopen('css/20-styles.css','w');
...
<head>
    ...
    <link href="<?php echo $url_path ?>/css/20-styles.css" rel="stylesheet" type="text/css" />
