...
require_once 'lib/scss.inc.php';
    ...
    $styles = $scss->compile('@import "16-styles.scss";');

    $css = fopen('css/16-styles.css','w');
...
<head>
    ...
    <link href="<?php echo $url_path ?>/css/16-styles.css" rel="stylesheet" type="text/css" />
    <link href="<?php echo $url_path ?>/css/bootstrap.min.css" rel="stylesheet" type="text/css" />
    <link href="<?php echo $url_path ?>/fonts/font-awesome/all.min.css" rel="stylesheet"/>
    <link href="<?php echo $url_path ?>/family-font/Roboto-Black.ttf"/>
